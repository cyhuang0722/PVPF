...
from sun_patch_prob.data import SunPatchSequenceDataset, prepare_frames
from sun_patch_prob.metrics import interval_coverage, pinball_loss, regression_metrics
from sun_patch_prob.model import SunPatchGatedProbabilisticModel, interval_width_regularizer, student_t_nll
...
def main() -> None:
    ...
    frames, feature_columns = prepare_frames(config["data"]["samples_csv"], config["data"]["feature_csv"], max_samples=args.max_samples)
