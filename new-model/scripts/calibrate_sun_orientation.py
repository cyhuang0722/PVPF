...
from new_model.data.solar_geometry import Calibration, compute_solar_position, project_sun_to_image
from new_model.utils.io import ensure_dir, load_json, save_json
